const {osu_db_load, beatmap_property, osu_db_save, Gamemode} = require('osu-tools');
const path = require('path');

const osu_path = 'D:\\osu!\\osu!.db'

const osu_db_result = osu_db_load(osu_path, [
...
//osu_db_save(osu_db_result, 'osu!.db', {print_progress: true, is_look_last_beatmap: false});